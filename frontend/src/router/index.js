...
const routes = [
  ...
  { path: '/try', name: 'try', component: () => import('../pages/TryPage.vue'), meta: { title: 'Try spoken Finnish - no account needed - SaunaSpeak', description: 'Hear and learn real spoken-Finnish sentences right now - no account, no signup. This is the Finnish Finns actually speak.' } },
  { path: '/lessons', name: 'lessons-index', component: () => import('../pages/LessonsIndexPage.vue'), meta: { title: 'Spoken Finnish lessons, free to read - SaunaSpeak', description: 'Browse every SaunaSpeak lesson: real spoken Finnish (puhekieli) with the written form, word-by-word explanations and audio - from your first words to city slang, free to read.' } },
